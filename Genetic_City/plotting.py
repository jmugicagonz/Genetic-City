...
def radar_plot(path_images_radar, dictionary_rules_fitness, generation, counter3):
    ...
    # ipdb.set_trace()
    # number of variable
    categories = list(['accesibility', 'green_space_balance_amount', 'green_space_balance_width', 'diversity_of_housing',
                       'diversity_of_office', 'house_office_walkable', 'access_to_parks', 'house_office_balance', 'people_fitting'])
    N = len(categories)
    ...
    plt.yticks([10, 20, 30, 40, 50, 60, 70, 80, 90], [
               "10", "20", "30", "40", "50", "60", "70", "80", "90"], color="grey", size=7)
    plt.ylim(0, 100)
